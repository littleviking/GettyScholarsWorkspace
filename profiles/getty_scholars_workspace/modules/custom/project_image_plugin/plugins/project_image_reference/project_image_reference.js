...
Drupal.wysiwyg.plugins['project_image_reference'] = {

  /**
   * Return whether the passed node belongs to this plugin.
   */
  isNode: function(node) {
    return ($(node).is('.project_image_reference'));
  },
  ...
  invoke: function(data, settings, instanceId) {
    ...
    if (!isNaN(parseFloat(gid)) && isFinite(gid)) {
      ...
      var url = Drupal.settings.basePath+"project-image/list/" + gid + "?instanceID=" + instanceId;
